...
public class MinesweeperGame {
  ...
  private static void actOnCell(String callInput, String userActionInput) {
  ...
  private static int getSelectedRowIndex(String callInput) {
    char cellInputRow = callInput.charAt(1);
    return convertRowFrom(cellInputRow);
  }

  private static int getSelectedColIndex(String callInput) {
